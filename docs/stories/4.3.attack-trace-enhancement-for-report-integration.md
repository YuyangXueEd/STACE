...
- [ ] Traces include failure analysis: why certain hypotheses didn't lead to vulnerabilities (AC: 3)
  - [ ] Add implementation subtasks
- [ ] Dual format: JSON (machine-readable) saved to `outputs/attack_traces/trace_{run_id}.json` + Markdown (human-readable) saved to `outputs/attack_traces/trace_{run_id}.md` (AC: 4)
  - [ ] Add implementation subtasks
