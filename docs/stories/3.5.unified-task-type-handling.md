...
- [ ] Loop Orchestrator modified to accept task_type parameter: "data_based" or "concept_erasure" (AC: 1)
  - [ ] Add implementation subtasks
- [ ] Orchestrator routes to appropriate tools and evaluators based on task_type (AC: 2)
  - [ ] Add implementation subtasks
- [ ] Loop configuration `configs/loop_config.yaml` specifies task-specific settings: max iterations, evaluation thresholds, target methods (AC: 3)
  - [ ] Add implementation subtasks
- [ ] Attack traces clearly indicate task type and use appropriate terminology (AC: 4)
  - [ ] Add implementation subtasks
- [ ] System can run data-based and concept-erasure tasks sequentially without code changes (only config changes) (AC: 5)
  - [ ] Add implementation subtasks
